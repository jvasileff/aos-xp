 ...
 */
public class XpView extends InternalResourceView {
     ...
     * @see XpUtils#getJstlAwareMessageSource
     */
    public XpView(String url, MessageSource messageSource) {
        this(url);
    ...
    protected void initServletContext(ServletContext servletContext) {
        if (this.messageSource != null) {
            this.messageSource = XpUtils.getJstlAwareMessageSource(servletContext, this.messageSource);
        }
     ...
     * @see XpUtils#exposeLocalizationContext
     */
    protected void exposeHelpers(HttpServletRequest request) throws Exception {
        if (this.messageSource != null) {
            XpUtils.exposeLocalizationContext(request, this.messageSource);
        }
        else {
            XpUtils.exposeLocalizationContext(new XpRequestContext(request, getServletContext()));
        }
    }
