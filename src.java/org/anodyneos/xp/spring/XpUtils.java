...
public abstract class XpUtils {
     ...
     */
    public static void exposeLocalizationContext(XpRequestContext requestContext) {
        Config.set(requestContext.getRequest2(), Config.FMT_LOCALE, requestContext.getLocale());
        MessageSource messageSource = getJstlAwareMessageSource(
                requestContext.getServletContext2(), requestContext.getMessageSource());
        LocalizationContext jstlContext = new SpringLocalizationContext(messageSource, requestContext.getRequest2());
        Config.set(requestContext.getRequest2(), Config.FMT_LOCALIZATION_CONTEXT, jstlContext);
    }
